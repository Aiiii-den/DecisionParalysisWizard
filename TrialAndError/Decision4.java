...
public class Decision4 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(src instanceof JButton && !this.tf.isEmpty() && n==JOptionPane.YES_OPTION) {
		...
		if(src instanceof JButton && src==this.history) {
			...
			if(this.tf.isEmpty() && this.histSt=="") {
